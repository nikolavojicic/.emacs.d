...
| f11     | maximize frame           |   | M-f11   | fullscreen frame       |
...
2. Computer -> Properties -> Advanced system settings -> Environment Variables -> System variables -> Path -> Edit -> add =C:\emacs-version\bin=
3. Create folder =C:\home=
4. Computer -> Properties -> Advanced system settings -> Environment Variables -> System variables -> New -> Variable name: =HOME= Variable value: =C:\home=
...
- [[https://sourceforge.net/projects/mingw/][MinGW]]
- [[https://sourceforge.net/projects/clisp/][CLisp]]
- [[https://scheme.com/download/][Chez Scheme]]
- [[https://docs.aws.amazon.com/corretto/][Java]]
...
- [[https://download.eclipse.org/jdtls/milestones/][Java Language Server]]
...
Ensure Environment Variables -> System variables -> Path:
- C:\Program Files\emacs\bin
- C:\Program Files\7-Zip
- C:\Program Files\Git\cmd
- C:\Program Files\Git\usr\bin
- %scripts% (put =clj-kondo=, =jq=, =mupdf=, =mutool=, =plantuml=, and other simple executables here)
- C:\MinGW\bin
- C:\Program Files\clisp
- C:\Program Files (x86)\Chez Scheme\bin\i3nt
- %JAVA_HOME%\bin
...
- C:\Program Files\Java\jdt-language-server\bin
- C:\Program Files\MiKTeX\miktex\bin\x64\
- C:\Program Files\PostgreSQL\14\bin

Ensure Environment Variables -> User variables for ... -> Path:
- %USERPROFILE%\.lein\bin
- %USERPROFILE%\AppData\Roaming\npm

| Variable type | Variable name | Variable value                   |
|---------------+---------------+----------------------------------|
| System        | scripts       | C:\Program Files\scripts         |
| System        | JAVA_HOME     | C:\Program Files\Java\jdk_latest |
| User          | orgmode       | %USERPROFILE%\workspace\orgmode  |

Consider adding most of these (and other programming-related dirs like jdtls and npm in %USERPROFILE%\AppData) to Windows Security -> Virus & threat protection settings -> Manage settings -> Add or remove exclusions.
